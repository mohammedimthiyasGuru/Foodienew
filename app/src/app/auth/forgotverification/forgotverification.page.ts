...
@Component({
  selector: 'app-forgotverification',
  templateUrl: './forgotverification.page.html',
  styleUrls: ['./forgotverification.page.scss'],
})
export class ForgotverificationPage implements OnInit {
 ...
 submit(){
   ...
   console.log(a);
   this.CustomerService.forgotpassword_verify(a).subscribe(res => {
     console.log(res);
