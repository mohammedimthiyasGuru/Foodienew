...
constructor(private StatusBar : StatusBar,private router: Router,private locationData : countrycode,private storage: LocalStorage) {
    this.StatusBar.show();
...
ngOnInit(): void {
  this.tracking_detail = this.storage.tracking_detail;
  console.log(this.tracking_detail);
}
...
mockDirections() {
  ...
  let  locationData = this.locationData.country;
