...
module.exports = function (app, event) {
    ...
    app.get('/country/:catid', function (req, res) {
        event.body = req.body;
        event.headers = req.headers;
    ...
    app.put('/country/:catid', function (req, res) {
        event.body = req.body;
        event.headers = req.headers;
        event.pathParams = { cat_id: req.params.catid };
     ...
     ///////update category by id /////
     app.put('/country/:catid/status', function (req, res) {
        event.body = req.body;
        event.headers = req.headers;
        event.pathParams = { cat_id: req.params.catid };
    ...
    //// delete category /////
    app.delete('/country/:catid', function (req, res) {
        event.headers = req.headers;
        event.pathParams = { cat_id: req.params.catid };
