...
@Component({
  selector: 'app-mob-order-view',
  templateUrl: './mob-order-view.component.html',
  styleUrls: ['./mob-order-view.component.scss'],
})
export class MobOrderViewComponent implements OnInit {
