...
@Component({
  selector: 'app-mob-message-forgotpassword',
  templateUrl: './mob-message-forgotpassword.component.html',
  styleUrls: ['./mob-message-forgotpassword.component.scss'],
})
export class MobMessageForgotpasswordComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.auth
      .forgetpassword(controls.email.value).subscribe(otp => {
        ...
        this.router.navigateByUrl('/mob_message_forgototp');
        let a = {
          user_id: otp.user_id,
