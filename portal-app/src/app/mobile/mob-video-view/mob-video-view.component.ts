...
@Component({
  selector: 'app-mob-video-view',
  templateUrl: './mob-video-view.component.html',
  styleUrls: ['./mob-video-view.component.scss'],
})
export class MobVideoViewComponent implements OnInit {
