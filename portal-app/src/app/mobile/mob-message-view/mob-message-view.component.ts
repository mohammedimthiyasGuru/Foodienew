...
@Component({
  selector: 'app-mob-message-view',
  templateUrl: './mob-message-view.component.html',
  styleUrls: ['./mob-message-view.component.scss'],
})
export class MobMessageViewComponent implements OnInit {
