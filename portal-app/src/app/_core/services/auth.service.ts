...
const API_FB_TOKEN = RemoteConfig.BASE_URL + '/auth/fb_token';
...
export class AuthService {
  ...
  update_fb_token(user: any): Observable<any> {
    return this.http.post<any>(API_FB_TOKEN, user, { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) }).pipe(catchError(this.httpUtils.errorHandler));
  }
